...
В результате выполнения четвертого этапа индивидуального проекта были приобретены навыки использования сканера nikto для тестирования веб-приложений

# Список литературы

[1] Методические материалы курса.

[2] Kali Linux Tool Documentation: Nikto (URL: https://www.kali.org/tools/hydra/)
